...
function AdminPage() {
                ...
                "AdminPage.useEffect.fetchUsers": async ()=>{
                    try {
                        ...
                        const usersList = querySnapshot.docs.map({
                            "AdminPage.useEffect.fetchUsers.usersList": (doc)=>{
                                const data = doc.data();
                        ...
                        }["AdminPage.useEffect.fetchUsers.usersList"]);
                        setUsers(usersList);
                    } catch (error) {
    ...
    const toggleUserStatus = async (user, field)=>{
        try {
            ...
            // Update local state
            setUsers((prevUsers)=>prevUsers.map((u)=>u.uid === user.uid ? {
                        ...u,
                        [field]: !u[field]
                    } : u));
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(`User ${field === 'isAdmin' ? 'admin status' : 'verification status'} updated`);
        } catch (error) {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Manage user verification and admin status"
                    }, void 0, false, {
                        fileName: "[project]/app/(admin)/admin/page.tsx",
                        lineNumber: 80,
                        columnNumber: 9
...
_s(AdminPage, "+quVjBMM9THpHvnUcBaphXhhZmo=");
_c = AdminPage;
var _c;
...
//# sourceMappingURL=app_%28admin%29_admin_page_tsx_fd65e954._.js.map